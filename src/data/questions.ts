...
export const SURVEY_QUESTIONS: Question[] = [
  ...
  // Personal Background
  { id: 'PB_01', question: 'Age', category: 'Personal Background', categoryCode: 'PB', type: 'multiple_choice', options: ['1 year', '2 years', '3 years', '4 years', '5 years', '6 years', '7 years', '8 years', '9 years', '10 years', '11 years', '12 years', '13 years', '14 years', '15 years', '16 years', '17 years', 'Less than 1 year', 'More than 17 years'], interviewSection: '1. Opening & Background' },
  ...
  { id: 'PE_03', question: 'How frequently are you paid?', category: 'Payment & Earnings', categoryCode: 'PE', type: 'multiple_choice', options: ['Daily', 'Weekly', 'Bi-weekly', 'Monthly', 'After each task', 'Other'], interviewSection: '5. Payment & Income' },
  ...
  { id: 'PE_04a', question: 'How often do you experience payment delays?', category: 'Payment & Earnings', categoryCode: 'PE', type: 'multiple_choice', options: ['Never', 'Rarely', 'Sometimes', 'Often', 'Always'], followUpTo: 'PE_04', interviewSection: '5. Payment & Income' },
  ...
  { id: 'PE_06', question: 'How do you receive payment?', category: 'Payment & Earnings', categoryCode: 'PE', type: 'multiple_choice', options: ['Bank transfer', 'Mobile money', 'Cash', 'Digital wallet', 'Cryptocurrency', 'Other'], interviewSection: '5. Payment & Income' },

  // Work Costs
  { id: 'WC_01', question: 'What proportion of your income goes to work costs?', category: 'Work Costs', categoryCode: 'WC', type: 'multiple_choice', options: ['0-10%', '11-25%', '26-50%', '51-75%', '76-100%'], interviewSection: '6. Work Expenses' },
  ...
  { id: 'CT_06a', question: 'How far ahead are you notified of changes?', category: 'Contracts & Terms', categoryCode: 'CT', type: 'multiple_choice', options: ['Same day', '1-3 days', '1 week', '2 weeks', '1 month', 'More than 1 month'], followUpTo: 'CT_06', interviewSection: '8. Legal Framework' },
  ...
  // Platform Comparison
  { id: 'PC_01', question: 'How does this platform compare to others in the sector?', category: 'Platform Comparison', categoryCode: 'PC', type: 'multiple_choice', options: ['Much better', 'Better', 'About the same', 'Worse', 'Much worse', 'No other platforms to compare'], interviewSection: '16. Final Assessment' },
