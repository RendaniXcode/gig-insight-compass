...
export const SURVEY_QUESTIONS: Question[] = [
  ...
  // Personal Background
  { id: 'PB_01', question: 'Age and highest education level', category: 'Personal Background', categoryCode: 'PB', type: 'text' },

  // Platform Introduction
  { id: 'PI_01', question: 'How long have you been working for this platform?', category: 'Platform Introduction', categoryCode: 'PI', type: 'text' },
  ...
  { id: 'PO_02', question: 'What challenges do you face with this work?', category: 'Platform Overview', categoryCode: 'PO', type: 'text' },
  ...
  // Work Structure
  { id: 'WS_01', question: 'How many hours per day do you work on this platform?', category: 'Work Structure', categoryCode: 'WS', type: 'text' },
  ...
  { id: 'WS_03', question: 'How does the app assign tasks?', category: 'Work Structure', categoryCode: 'WS', type: 'text' },
  ...
  { id: 'PE_06', question: 'How do you receive payment? Can you choose currency?', category: 'Payment & Earnings', categoryCode: 'PE', type: 'text' },

  // Work Costs
  { id: 'WC_01', question: 'What proportion of your income goes to work costs?', category: 'Work Costs', categoryCode: 'WC', type: 'text' },
  { id: 'WC_02', question: 'Do you pay commission or fees to the platform?', category: 'Work Costs', categoryCode: 'WC', type: 'yes_no' },
  { id: 'WC_03', question: 'Does your income fluctuate? Why?', category: 'Work Costs', categoryCode: 'WC', type: 'text' },

  // Unpaid Work Time
  { id: 'UWT_01', question: 'Is some work time unpaid (like applying for jobs)? How much?', category: 'Unpaid Work Time', categoryCode: 'UWT', type: 'text' },
  ...
  { id: 'CT_04', question: 'Where can you access the contract/terms?', category: 'Contracts & Terms', categoryCode: 'CT', type: 'text' },
  { id: 'CT_05', question: 'Do terms include pay details bonuses incentives?', category: 'Contracts & Terms', categoryCode: 'CT', type: 'yes_no' },
  { id: 'CT_06', question: 'If contract changes are you notified? How far ahead?', category: 'Contracts & Terms', categoryCode: 'CT', type: 'text' },
  ...
  { id: 'HS_04', question: 'Does platform provide insurance? What does it cover?', category: 'Health & Safety', categoryCode: 'HS', type: 'text' },

  // Data & Privacy
  { id: 'DP_01', question: 'What data does the platform collect about you?', category: 'Data & Privacy', categoryCode: 'DP', type: 'text' },
  { id: 'DP_02', question: 'Does platform inform you about data collection?', category: 'Data & Privacy', categoryCode: 'DP', type: 'yes_no' },
  { id: 'DP_03', question: 'What measures protect your data?', category: 'Data & Privacy', categoryCode: 'DP', type: 'text' },

  // Platform Management
  { id: 'PM_01', question: 'How does the rating system work?', category: 'Platform Management', categoryCode: 'PM', type: 'text' },
  { id: 'PM_02', question: 'Can you appeal a bad rating?', category: 'Platform Management', categoryCode: 'PM', type: 'yes_no' },
  { id: 'PM_03', question: 'Who do you contact when something goes wrong?', category: 'Platform Management', categoryCode: 'PM', type: 'text' },
  { id: 'PM_04', question: 'What channels exist for wage issues?', category: 'Platform Management', categoryCode: 'PM', type: 'text' },
  { id: 'PM_05', question: 'What channels exist for suspension/deactivation issues?', category: 'Platform Management', categoryCode: 'PM', type: 'text' },

  // Support Experience
  { id: 'SE_01', question: 'Have you contacted support before?', category: 'Support Experience', categoryCode: 'SE', type: 'yes_no' },
  { id: 'SE_02', question: 'What was the issue and how was it handled?', category: 'Support Experience', categoryCode: 'SE', type: 'text' },
  ...
  { id: 'DUE_02', question: 'How can you contest management decisions?', category: 'Due Process', categoryCode: 'DUE', type: 'text' },
  ...
  // Worker Voice
  { id: 'WV_01', question: 'What say do you have in shaping platform policies?', category: 'Worker Voice', categoryCode: 'WV', type: 'text' },
  { id: 'WV_02', question: 'Are there collective mechanisms to empower workers?', category: 'Worker Voice', categoryCode: 'WV', type: 'yes_no' },
  { id: 'WV_03', question: 'What channels do workers use to share ideas collectively?', category: 'Worker Voice', categoryCode: 'WV', type: 'text' },
  ...
  { id: 'CA_03', question: 'How do you appeal bad ratings or decisions?', category: 'Collective Action', categoryCode: 'CA', type: 'text' },

  // Platform Comparison
  { id: 'PC_01', question: 'How does this platform compare to others in the sector?', category: 'Platform Comparison', categoryCode: 'PC', type: 'text' },
  { id: 'PC_02', question: 'What one thing would you change about this platform?', category: 'Platform Comparison', categoryCode: 'PC', type: 'text' },

  // Research Documentation
  { id: 'RD_01', question: 'Key quotes and observations', category: 'Research Documentation', categoryCode: 'RD', type: 'text' },
  { id: 'RD_02', question: 'Interviewer reflections', category: 'Research Documentation', categoryCode: 'RD', type: 'text' }
];
